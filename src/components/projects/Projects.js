          ...
          <Row xs={1} md={2} noGutters={true}>
            <Col className="center-column">
              <ProjectItem
                ...
                description={
                  "This is the website that you are currently browsing! Designed from scratch without a template. Animations implemented using Framer Motion, and Dark Mode Toggle implemented with help from Styled Components."
                }
                icons={{
                  React: <FaReact />,
                  HTML5: <FaHtml5 />,
            ...
            <Col className="center-column">
              <ProjectItem
                ...
                linkText={"Github"}
                description={
                  "Website that verifies whether a user-uploaded Tweet was authentic or photoshopped using Google Cloud Vision API. Built for Hack the North 2021."
                }
                icons={{
                  React: <FaReact />,
                  HTML5: <FaHtml5 />,
            ...
            <Col className="center-column">
              <ProjectItem
                ...
                title={"CovED"}
                description={
                  "Website that compiles learning resources based on different high school curriculums around Canada. Built for students who are struggling through online learning during the COVID-19 pandemic."
                }
                icons={{
                  HTML5: <FaHtml5 />,
                  CSS3: <FaCss3Alt />,
            ...
            <Col className="center-column">
              <ProjectItem
                ...
                title={"Skatezy"}
                description={
                  "Web application that helps users track their figure skating skills and metrics."
                }
                icons={{
                  Flask: <FaFlask />,
                  Python: <FaPython />,
